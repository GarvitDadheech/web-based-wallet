        ...
        <div className="bg-gray-800 rounded-2xl p-8 shadow-2xl border border-blue-500/20 backdrop-blur-xl">
          <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            ...
            <div className='flex items-center mb-8 space-x-4'>
                ...
                className="flex-1 bg-gray-700 border-2 border-blue-500/30 rounded-2xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-all duration-300 placeholder-gray-400"
                />
                <button
                    onClick={handleGenerateMnemonic}
                    className=" px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-xl transition-all duration-300 flex items-center gap-2"
                >
