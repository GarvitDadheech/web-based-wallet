    ...
    return (
        <div className="mb-8 animate-fadeIn">
            ...
            {isVisible && (
                ...
                >
                    <div className="absolute bottom-2 right-2 text-sm text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        Click to copy
                    </div>
                    ...
                    {mnemonics.map((word, index) => (
                        <div
                            key={index}
                            className="flex items-center gap-2 p-2 bg-gray-800 rounded-xl border border-purple-500/20 animate-slideIn select-none"
                            style={{
            ...
            {isVisible && (
                <div className="mt-4 p-3 bg-yellow-900/20 border border-yellow-500/20 rounded-2xl flex items-center gap-3">
